                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle">Berikut adalah data Jenis Biaya</h6>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?= base_url('Master/Jenis_biaya/add_JB')?>" method="post">
          <div class="form-group">
            <label class="col-form-label">Jenis Biaya:</label>
            <input type="text" name="jns_biaya" class="form-control" required>
          </div>
...
<?php
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?= base_url('Master/Jenis_biaya/edit_JB')?>" method="post">
          ...
          <div class="form-group">
            <label class="col-form-label">Jenis Biaya:</label>
            <input type="text" name="jns_biaya" class="form-control" value="<?= $row['jns_biaya'];?>" required>
          </div>
...
<?php
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?= base_url('Master/Jenis_biaya/delete_JB')?>" method="post">

        <input type="hidden" name="id" class="form-control" value="<?= $row['id'];?>">
        <p>Apkah anda yakin Mneghapus data Jenis Biaya <strong> <?= $row['jns_biaya']?> </strong> ?</p>
