  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?= base_url('Master/Jenis_transaksi/addJT')?>" method="post">
...
<?php
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?= base_url('Master/Jenis_transaksi/editJT')?>" method="post">
